        ...
        return (
            <div>
                <Map>
                    <Layers>
                        <layer.OSM />
                        <layer.Vector features={this.state.features} style={[style, style2]} layerKey="worldPoints"/>
                    </Layers>
                    <Interactions>
                        ...
                        <interaction.Modify
                            ...
                            modifyend={(feature) => { this.modifyEnd.call(this, feature) }}
                            style={modifyStyle}
                        />

                        <interaction.Modify
                            layerKey={'worldPoints'}
                            modifyend={(feature) => { this.modifyEnd.call(this, feature) }}
                            style={modifyStyle}
                        />
                    </Interactions>
